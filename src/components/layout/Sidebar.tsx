...
const GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: '/dashboard/rules', label: 'Auto-Rules' },
    ],
  },
  {
    label: 'Planning',
    ...
    items: [
      ...
      { href: '/dashboard/goals', label: 'Savings Goals' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/debt', label: 'Debt Planner' },
      { href: '/dashboard/vault', label: 'Savings Vault' },
    ],
  },
  {
    label: 'Analytics',
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/credit-score', label: 'Credit Score' },
      { href: '/dashboard/rewards', label: 'Rewards' },
    ],
  },
  {
    label: 'More',
    icon: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="4" r="1" fill="currentColor"/><circle cx="8" cy="8" r="1" fill="currentColor"/><circle cx="8" cy="12" r="1" fill="currentColor"/></svg>,
    items: [
      { href: '/dashboard/household', label: 'Household' },
      { href: '/dashboard/tax', label: 'Tax Organizer' },
    ],
  },
]
