  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-up">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-900 tracking-tight dark:text-slate-100">Spending Alerts</h1>
      ...
      {loading ? (
        ...
        <div className="card p-16 text-center">
          ...
          <h2 className="text-sm font-semibold text-slate-900 mb-2 dark:text-slate-100">No alerts</h2>
          <p className="text-sm text-slate-500 max-w-xs mx-auto dark:text-slate-400">
        ...
        <div className="space-y-2">
          {alerts.map(alert => (
            <div key={alert.id} className={`card p-4 border ${SEVERITY_COLORS[alert.severity] || 'bg-white'} ${!alert.read ? 'ring-1 ring-teal-400' : ''}`}>
