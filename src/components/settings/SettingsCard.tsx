...
export function SettingsCard({ title, description, children, danger }: SettingsCardProps) {
  return (
    <div className={`card p-6 space-y-5 ${danger ? 'border-red-100 dark:border-red-900/40' : ''}`}>
      <div>
...
export function SettingsRow({ label, description, children }: SettingsRowProps) {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 py-4 border-t border-slate-50 first:border-t-0 first:pt-0 last:pb-0 dark:border-slate-800">
